...
namespace BirdBoxFull.Server.Migrations
{
    ...
    [Migration("20240114215628_Fith4")]
    partial class Fith4
    {
            ...
            modelBuilder.Entity("BirdBoxFull.Shared.Encomenda", b =>
                {
                    ...
                    b.Property<string>("LeilaoCodLeilao1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("LeilaoCodLeilao1")
                        .IsUnique()
                        .HasFilter("[LeilaoCodLeilao1] IS NOT NULL");
            ...
            modelBuilder.Entity("BirdBoxFull.Shared.Encomenda", b =>
                {
                    ...
                    b.HasOne("Leilao", null)
                        .WithOne("Encomenda")
                        .HasForeignKey("BirdBoxFull.Shared.Encomenda", "LeilaoCodLeilao1");
